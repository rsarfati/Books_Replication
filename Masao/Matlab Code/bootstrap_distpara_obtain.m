...
[llh, newdistpara] = fullmodelllhWFAug22newtest2015(x0,distpara0,gamma0vec,deltavec, data12,data09,bp);
dlmwrite('estimates_distpara.csv',newdistpara,'delimiter',',','-append');
...
for i = beginning:ending
    ...
    %}
    [llh, newdistpara,fother,fWF] = fullmodelllhWFAug22newtest2015(xinitial,distpara0,gamma0vec,deltavec, bdata12,bdata09,bbp);
