...
function estimate_model(; # Data specification
						  ...
						  # Parameter specification
							...
							#=5=#	:γ_ns_on_12 	=> 0.3026, #5  γ_ns_on_12 * 8.0 ^ (-η) / (10 * r * γ_ns_shape)
							#=6=#	:η          	=> 0.8756,#0.87235, #6  η - 1   *** I am infering there is meant to be a -1 transformation
							#=7=#	:r          	=> 0.5,     #7  r * 10  *** FIXED
							#=8=#	:R_p        	=> 0.933,#0.25921, #8  R_p
							#=9=#	:c          	=> -5.75,#-9.1217, #9  c * 10
							#=10=#	:γ_s_pop    	=> 69.265,#80.267,  #10 γ_s_pop * 100
							#=11=#	:γ_ns_pop   	=> -6.933, #11 γ_ns_pop * 10
							#=12=#	:s_R        	=> 1.6760,#1.7296,  #12 s_R
							#=13=#	:μ_R        	=> 7.6407,  #13 μ_R / s_R
							#=14=#	:R_q        	=> 0.9278, #14 1 - R_q
							#=15=#	:γ_s_shape  	=> 0.333,#4.283,   #15 γ_s_shape
							#=16=#	:γ_s_on_09  	=> 5.696,#4.9097,  #16 γ_s_on_09
							#=17=#	:γ_s_on_12  	=> 14.1382,#0.0,     #17 γ_s_on_12
							#=18=#	:σ_δ        	=> 7.5144,  #18 σ_δ
							#=19=#	:γ_ns_of_09_std => 0.0211,   #19 γ_ns_of_09_std
	...
	res = optimize(obj_fun, lb[free_ind], ub[free_ind],
				   θ_val[free_ind], Fminbox(),#SAMIN(),#ParticleSwarm(lower=lb[free_ind], upper = ub[free_ind], n_particles = 3),
