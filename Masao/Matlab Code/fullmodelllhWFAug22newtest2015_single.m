function [f,distpara,fother,fWF] = fullmodelllhWFAug22newtest2015_single(x0,distpara0,gamma0vec,deltavec, data12,data09,bp,cindex)
...
% betasigma4
%%
% gamma0shape = betasigma4(1);
% gamma0theta09 = betasigma4(2)/gamma0shape;
% gamma0theta12 = betasigma4(3)/gamma0shape;
...
% xprobsize = diff([0 gamcdf(xhalf,betasigma5(9),1)]);
% xsize = diff([0 xhalf]);
% pdfdata2 = xprobsize./xsize;
% pdfdata1 = x(1:end-1);
%
% save pdfdata pdfdata1 pdfdata2
%
% save gamma0delta.mat gamma0deltavec
...
% basellh12 = gamcdf(data12.p+0.025,olm,oltheta) - gamcdf(data12.p-0.025,olm,oltheta);
% basellh12pdfmeasure = gampdf(data12.p,olm,oltheta);
%
%
% save basicnumbers.mat
%
% i = 1540;
% betasigmatemp = betasigma4;
% vectemp = gamma0deltavec(i,:);
% obscalnew([vectemp(1) betasigmatemp([6 7 8 10 11 12]) lamda1 lamda2 betacond betapop 0 betasigmatemp(13) vectemp(2) betasigmatemp(14)],data12,basellh12,1,data12.pdif);
%
%
% dsfsd
...
maxtemp09 = maxtemp09(cindex,:);
llhadj09 = llhadj09(cindex,:);
...
maxtemp12 = maxtemp12(cindex,:);
llhadj12 = llhadj12(cindex,:);
...
f1 = integgamma0(betasigma4(1:4));
distpara1 = betasigma4(1:4);
...
f2 = getbmean(betasigma5(5:6));
distpara2 = betasigma5(5:6);
