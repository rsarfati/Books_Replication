...
true_estimates = [0.32135	5.6459	14.855	1.1614	0.6486	1.9196	14.771	-2.4895	1	0.44004	0.32415	0.87235	0.5	0.25921	-9.1217	80.267	-13.647	1.7296	8.8188	0.92622	4.283	4.9097	0	7.8609	7.739	0.011111	6.8386	6.5027	0.028621];
...
% The following 3 lines are for reduced-form server, Change resource parameters (walltime and mem) if necessary 
% dcluster=parcluster;
...
%% Some data rename and setup before bootstraps start.
...
%outside of matlab. Column definitions are same as rows in
%Summary201609.xlsx. 
